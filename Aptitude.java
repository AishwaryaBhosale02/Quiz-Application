...
public class Aptitude extends javax.swing.JFrame
{
    ...
    public Aptitude() 
    {
       ...
       { 
           ...
           myres=mystate.executeQuery("select *from aptiquestion");
           System.out.println(mycon);
           txtarea.setFont(new Font("Tahona",Font.PLAIN,20));
           txtarea.append("APTITUDE QUESTIONS\n\n");           
           int y=100;
           while(myres.next())
           {
               btngrp[j]=new ButtonGroup();
              txtarea.append(myres.getString(("que") ));
              txtarea.append("\n\n");
        ...
        pnlLayout.setVerticalGroup(
            ...
            .addGroup(pnlLayout.createSequentialGroup()
                ...
                .addGroup(pnlLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(btnnext, javax.swing.GroupLayout.DEFAULT_SIZE, 48, Short.MAX_VALUE)
    ...
    @Override
     public void actionPerformed(ActionEvent e)
     {
       ...
       int i=1;
        ...
        System.out.println("reusult  be4 anything : "+a.result);
        Connection mycon=null;
        Statement mystate=null;
        ResultSet myres=null;
        try
        {
             mycon=DriverManager.getConnection("jdbc:mysql://localhost:3306/questions","root","Quiz123@");
             String query="select ans from aptiquestion where idaptiquestion = '"+k+"'";
             mystate=mycon.createStatement();
             ...
             //System.out.println(mycon);
                    ...
                    {
                        JOptionPane.showMessageDialog(a,"Result not found");
                    }
                    //a.result++;
        }
        catch(Exception exp)
